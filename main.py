...
class MainApp(QMainWindow):
    ...
    def create_menu_bar(self):
        ...
        # maximize
        maxscr_action = QAction('Maximize', self)
        ...
        # windowed
        winscr_action = QAction('Windowed', self)
        winscr_action.triggered.connect(lambda : self.showNormal())
        view_menu.addAction(winscr_action)
        ...
        # theme
        theme_windows = QAction('Windows Theme', self)
        theme_windows.triggered.connect(self.theme_windows)
        view_menu.addAction(theme_windows)

        theme_gtk2 = QAction('GTK2 Theme', self)
        theme_gtk2.triggered.connect(self.theme_gtk2)
        view_menu.addAction(theme_gtk2)
    ...
    def create_toolbar(self):
        ...
        # undo
        undo_action = QAction(QIcon("Sentence/IconsBlack/undo.png"), 'Undo', self)
        undo_action.triggered.connect(self.editor.undo)
        ToolBar.addAction(undo_action)

        # redo
        redo_action = QAction(QIcon("Sentence/IconsBlack/redo.png"), 'Redo', self)
        ...
        # copy
        copy_action = QAction(QIcon("Sentence/IconsBlack/copy.png"), 'Copy', self)
        copy_action.triggered.connect(self.editor.copy)
        ToolBar.addAction(copy_action)

        # cut
        cut_action = QAction(QIcon("Sentence/IconsBlack/cut.png"), 'Cut', self)
        cut_action.triggered.connect(self.editor.cut)
        ToolBar.addAction(cut_action)

        # paste
        paste_action = QAction(QIcon("Sentence/IconsBlack/paste.png"), 'Paste', self)
        paste_action.triggered.connect(self.editor.paste)
        ...
        self.font_combo.addItems(["Monospace", "Hellentic Typewriter Regular", "Helvetica", "Arial", "SansSerif", "Helvetica", "Times", "Courier Std"])
        ...
        # bold
        bold_action = QAction(QIcon("Sentence/IconsBlack/bold.png"), 'Bold', self)
        bold_action.triggered.connect(self.bold_text)
        ToolBar.addAction(bold_action)

        # underline
        underline_action = QAction(QIcon("Sentence/IconsBlack/underline.png"), 'Underline', self)
        underline_action.triggered.connect(self.underline_text)
        ToolBar.addAction(underline_action)

        # italic
        italic_action = QAction(QIcon("Sentence/IconsBlack/italic.png"), 'Italic', self)
        ...
        # text alignment
        right_alignment_action = QAction(QIcon("Sentence/IconsBlack/right-align.png"), 'Align Right', self)
        ...
        left_alignment_action = QAction(QIcon("Sentence/IconsBlack/left-align.png"), 'Align Left', self)
        ...
        justification_action = QAction(QIcon("Sentence/IconsBlack/justification.png"), 'Center/Justify', self)
        ...
        # zoom in
        zoom_in_action = QAction(QIcon("Sentence/IconsBlack/zoom-in.png"), 'Zoom in', self)
        zoom_in_action.triggered.connect(self.editor.zoomIn)
        ToolBar.addAction(zoom_in_action)

        # zoom out
        zoom_out_action = QAction(QIcon("Sentence/IconsBlack/zoom-out.png"), 'Zoom out', self)
